...
async def get_all_thresholds(current_user: dict = Depends(get_current_user)):
    return await ThresholdLogic.list_all_rules()
...
async def create_threshold(
    ...
    return await ThresholdLogic.add_rule(rule)
...
async def get_threshold_by_id(
    ...
    return await ThresholdLogic.get_rule_by_id(rule_id)
...
async def update_threshold(
    ...
    return await ThresholdLogic.update_rule(rule_id, rule)
...
async def delete_threshold(
    ...
    return await ThresholdLogic.delete_rule(rule_id)